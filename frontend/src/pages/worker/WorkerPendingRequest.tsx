...
export const WorkerPendingRequest: React.FC = () => {
  ...
  const [status, setStatus] = useState<'pending' | 'approved'>(() => {
    ...
    return saved === 'approved' ? 'approved' : 'pending';
  });
  ...
  const toggleApprovalForDemo = (newStatus: 'pending' | 'approved') => {
    setStatus(newStatus);
  ...
  const subtitleText = isApproved
    ? 'Congratulations! Your partner credentials and KYC have been verified. You can now access your dashboard and start accepting jobs.'
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0 pt-0.5">
                <div className="flex items-center justify-between">
                  ...
                  >
                    {isApproved ? completedText : inProgressText}
                  </span>
                </div>
                <p className="text-[11px] text-[#66737D] mt-0.5">
                  {isApproved
          ...
          {isApproved ? (
            ...
            <>
              ...
              >
                ...
                <span>Simulate Instant Approval (Test)</span>
              </button>
            </>
          )}
        </div>
